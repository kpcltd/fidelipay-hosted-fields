...
class Gateway {
	 ...
	 */
	static public $hostedUrl = 'https://gateway.fidelipay.co.uk/paymentform/';

	/**
	 * @var string	Gateway Direct API Endpoint
	 */
	static public $directUrl = 'https://gateway.fidelipay.co.uk/direct/';

	/**
	 * @var string	Merchant Account Id or Alias
	 */
	static public $merchantID = '101093';
	 ...
	 */
	static public $merchantSecret = 'Custom29Simple14Marker';
